...
(function (global, factory) {
    ...
    var defaultLocaleMonths = [...Array(12).keys()].map(key => new Date(0, key).toLocaleString(Navigator.language, { month: 'long' }))
    function localeMonths (m) {
        return this._months[m.month()];
    }

    /*var defaultLocaleMonthsShort = 'Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec'.split('_');*/
    var defaultLocaleMonthsShort = [...Array(12).keys()].map(key => new Date(0, key).toLocaleString(Navigator.language, { month: 'short' }))
    ...
    var defaultLocaleWeekdays = [...Array(7).keys()].map(key => new Date(0, 0, key).toLocaleString(Navigator.language, { weekday: 'long' }));
    function localeWeekdays (m) {
        return this._weekdays[m.day()];
    }

    /*var defaultLocaleWeekdaysShort = 'Sun_Mon_Tue_Wed_Thu_Fri_Sat'.split('_');*/
    var defaultLocaleWeekdaysShort = [...Array(7).keys()].map(key => new Date(0, 0, key).toLocaleString(Navigator.language, { weekday: 'short' }));
    function localeWeekdaysShort (m) {
        return this._weekdaysShort[m.day()];
    }

    /*var defaultLocaleWeekdaysMin = 'Su_Mo_Tu_We_Th_Fr_Sa'.split('_');*/
    var defaultLocaleWeekdaysMin = [...Array(7).keys()].map(key => new Date(0, 0, key).toLocaleString(Navigator.language, { weekday: 'short' }));
